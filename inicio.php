...
<form action="inicio.php" method="GET" class=" form-busqueda ">
	...
	<input name="origen" value="<?php echo $origen; ?>"  class="input-busqueda input_bus" type="text" placeholder="origen" id="origen" name="origen">

	<label for="destino">a:</label>
	<input name="destino" value="<?php  echo $destino; ?>"  class="input-busqueda input_bus"type="text" placeholder="destino" id="destino" name="destino">

	<label for="precio">Precio</label>
	<input name="minimo" value="<?php  echo $minimo; ?>" class="input-bn input_bus"  type="number" min="0" name="precio1" placeholder="minimo">

	<label for="precio2">a:</label>
	<input name="maximo" value="<?php echo $maximo ?>" class="input-bn input_bus"  type="number" min="0" name="precio2" placeholder="maximo">


	<label for="fecha1">De</label>
	<input name="fecha_min" value="<?php  echo $fecha_min; ?>" class="input-busqueda input_bus" type="date" id="fecha1" name="fecha1">

	<label for="fecha2">a:</label>
	<input name="fecha_max" value="<?php echo $fecha_max; ?>" class="input-busqueda input_bus" type="date" name="fecha2" id="fecha2">
