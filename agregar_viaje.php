...
<div class="conteiner-form">
	...
	<div>
		Cargar un:
		<a class="color-a" href="agregar_vehiculo_2.php">Nuevo vehiculo </a>
	</div>
	<div class="caja-viaje">
		<?php if ($hay_autos >0 ) { ?>
		<label for="vehiculo" class="">Seleccione un vehiculo: </label><span class="msj-viaje" id="msj_vehi" ></span>
		<br>
	...
	<div class="caja-viaje">
		...
		<label >Acompañantes:</label><span id="msj_eror_cop" class="msj-viaje"> </span>
		<br>
		<input type="number" name="copilotos"  id="copilotos" min="1" class=" focus_azul ">
		
		<p id="msj_cop" class="aviso ocultar ">recuerde que la cantidad de acompañantes debe de ser menor a la cantiad de asientos del vehiculo seleccionado</p>
				...
				<label class="habilitar">Seleccione un tipo de viaje</label>
				 <select class="s1 top focus_azul"name="tipo" id="tipo">
					...
					<p class="ocultar " id="diario">Lunes Martes Miercoles Jueves viernes</p>
				...
				<div class="caja-viaje">
					<label>Destino</label><span class="msj-viaje" id="msj_destino"></span>
					<input  class="input-f1 focus_azul" id="destino"type="text" name="destino" >
					</div>
				<div class="caja-viaje">
					<label >Costo</label><span class="msj-viaje" id="msj_costo"></span>
