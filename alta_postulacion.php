...
$existe = false;
	while ($fila = mysqli_fetch_array($resultado1)) {
		if ($fila['postulante_id'] == $_POST['id'] && $fila['viaje_id'] == $_POST['id_viaje']) {

			$existe = true;
		}
	}
	if ($existe == false){
		$consulta ="INSERT INTO postulantes(id, viaje_id, postulante_id, estado,rechazado,visto) VALUES (null, $_POST[id_viaje], $_POST[id], 1, 0,0) ";
		$resultado = mysqli_query($link,$consulta);
		$_SESSION['mensaje']=" Postulacion exitosa!!";
		header("Location:index.php"); 
		die();
    }else{
    		$consulta1 = " UPDATE postulantes SET estado = 1 where viaje_id = $_POST[id_viaje]";
    		$resultado1 = mysqli_query($link,$consulta1);
            $_SESSION['mensaje']=" Postulacion exitosa";
    		header("Location:inicio.php");
    		die();
