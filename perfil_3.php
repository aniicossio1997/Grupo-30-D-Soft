...
<div class=" menu">
	...
	<ul class="mov">
		<li class="lin"><a class="btn-link linea"  href="agregar_vehiculo.php"> Agregar vehículo</a></li>
		<li class="lin"><a class=" btn-link linea  " href="mis_vehiculos.php">Ver vehiculos</a></li>
		<li class="lin"><a class="btn-link linea " href="mis_viajes_postulados.php">ver viajes postulados</a></li>
		
		<li class="lin"><a class="btn-link linea " href="mostrar_viaje_piloto.php">ver viajes creados</a></li>
		<li class="lin"><a class="btn-link linea " href="ver_reputacion_como_piloto.php">ver reputación como piloto</a></li>
		<li class="lin"><a class="btn-link linea " href="ver_reputacion_como_copiloto.php">ver reputación como copiloto</a></li>
