...
?>
<h1 class ="h1_form color-a"> Reputacion Piloto</h1>
<form  style="margin: 0% auto;width:80%">
	<b class="p-perfil p-left" style="font-style: italic; margin-left: 4%">Puntaje total como Piloto: <?php echo ($mostrar - $mostrar2); ?></b>
	<article class="article_interior">
		<b>Lista de calificaciones:</b>
	<?php $consulta3 = "SELECT * FROM calificacion WHERE usuario_id = $id AND modo_calificacion = 1" ;
		  ...
		  if ($cantidad > 0) {
			  while ( $fila3 = mysqli_fetch_array($resultado3)) { 
					...
					if( $fila3['puntaje'] == 1) //bueno
					  $puntaje= "Bueno"; 
					$consulta4 = "SELECT nombre FROM usuarios WHERE id = $fila3[calificador_id]";
