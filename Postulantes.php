	...
	<article class="article_interior" style="width: 100%;">
		...
		<table>
			<tr class="Td-a" >
				...
				<td class="Td-a">
					<a class="btn btn-warning" onmouseout ="this.style.color='white'" href="rechazar_postulante.php?id=<?php echo $fila1['postulante_id']?>&id_viaje=<?php echo $id_viaje ?>&origen=<?php echo $_GET['origen'] ?>&destino=<?php echo $_GET['destino']?>">Rechazar</a>
				</td>
			</tr>
		</table>
	</article>	
